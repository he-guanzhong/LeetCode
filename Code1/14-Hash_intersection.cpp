...
// 哈希值较少，跨度大，不得使用数组。考虑集合
// set和multiset底层是红黑树，且排序，访问效率低。选择unordered_set，自带去重效果
// 由于要对num1的中间层、和最终结果去重，故需要两个set。
// 一为nums_set，保存nums1信息，直接初始化构造。
