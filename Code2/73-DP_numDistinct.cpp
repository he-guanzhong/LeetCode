...
// dp[i][0]相当于在s中寻找空集，必可能，为0。空集中找空集，可能，dp[0][0]=1
...
int main() {
  ...
  cout << numDistinct(s1, t1) << " " << numDistinct(s2, t2) << endl;
  cout << numDistinct1(s1, t1) << " " << numDistinct1(s2, t2) << endl;
  return 0;
}