...
grid[i][j] = 0 表示水域。网格中的格子 水平和垂直
方向相连（对角线方向不相连）。整个网格被水完全包围，
...
// 方法一，不必求岛屿数量，边定义为1对0，或1对边界的跨越。
// 故对每一个岛屿点四周搜索，遇到海水或者边界，周长直接加一。
// 方法二，边长=岛屿数量*4-相邻岛屿对数*2，遍历方向是左上到右下，
// 故每节点的对数计算，只能考虑其左、上两个方向，而且要分别记对
